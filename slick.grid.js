...
(function($) {
	...
	function SlickGrid(container, data, columns, options) {
		...
		// async call handles
		var heditorLoader = null;
		var hrender = null;
		var hpostrender = null;
		var postProcessedRows = {};
		var postProcessToRow = null;
		var postProcessFromRow = null;

		// perf counters
		var counterrowsrendered = 0;
		var counterrowsremoved = 0;
		...
		function startPostProcessing() {
			...
			clearTimeout(hpostrender);
			hpostrender = setTimeout(asyncPostProcessRows, options.asyncPostRenderDelay);
		}
		...
		function setActiveCellInternal(newCell, editMode) {
			...
			if (activeCellNode != null) {
				...
				if (options.editable && editMode && isCellPotentiallyEditable(activeRow, activeCell)) {
					clearTimeout(heditorLoader);

					if (options.asyncEditorLoading) {
						heditorLoader = setTimeout(function() {
							makeActiveCellEditable();
		...
		this.debug = function() {
			...
			s += ("\n" + "counterrowsrendered:  " + counterrowsrendered);
			s += ("\n" + "counterrowsremoved:  " + counterrowsremoved);
